...
export function CTAStrip() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-brand-blue to-brand-indigo py-24">
      {/* Decorative circles */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        <h2 className="text-4xl font-black text-white">Ready to start learning?</h2>
        <p className="mt-3 text-lg text-white/80">Jump in with demo data in seconds.</p>
        <Link
          href="/courses"
          className="mt-8 rounded-2xl bg-white px-10 py-4 font-bold text-brand-blue transition-transform hover:scale-105"
        >
          Get Started
        </Link>
      </div>
